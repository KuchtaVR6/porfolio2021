...
<head lang="en">
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-6GFDXTY07K"></script>
    <script>
        window.dataLayer = window.dataLayer || [];
        function gtag() { dataLayer.push(arguments); }
        gtag('js', new Date());

        gtag('config', 'G-6GFDXTY07K');
    </script>
</head>
    ...
    <div class="container-fluid p-0 m-0 w-100 d-inline">
        ...
        <div class="row p-0 m-0" id="experience">
            ...
            <div class="col-md-10">
                ...
                <p id="exp_text">
                    Although I am only 20 years old, I have already worked in 4 different companies. This of course gave
                    ...
                    <div class="col-md-6 pl-2 pr-2 pb-2">
                        <div class="binner">
                            <p style="text-align:left;">
                                ...
                                <b>
                                    ...
                                    • Gained skills in explaining programming principles<br>
                                </b>
                            </p>
                        </div>
                        <div class="binner mt-5">
                            <p style="text-align:left;">
                                ...
                                <b>
                                    • Provided friendly and efficient customer service<br>
                                    • Provided recommendations and information about food and drinks<br>
                                    • Recorded customer’s orders and took payments<br>
                                    • Completed, prepared, and served orders<br>
                                </b>
                            </p>
                        </div>
                        <br>
        ...
        <div class="row pb-5 m-0" id="contact">
            ...
            <div class="col-md-6">
                ...
                <p style="text-align:left;">
                    Email:
                    <span style="float:right;">
                        <a href="mailto: kuchtavr6@gmail.com">kuchtavr6@gmail.com</a>
                    </span><br>
                </p>
                <hr>
                <p style="text-align:left;">
                ...
                <p style="text-align:left;">
                    ...
                    <span style="float:right;">
                        <a
                            href="mailto: https://www.linkedin.com/in/patryk-kuchta-55a3301b6/">https://www.linkedin.com/in/patryk-kuchta-55a3301b6/</a>
                    </span><br>
                </p>
            </div>
            <div class="col-md-3">
